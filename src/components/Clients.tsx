    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
        ...
        <div className="text-center mb-20">
          <h3
            className="text-2xl md:text-3xl font-light tracking-widest text-blue-400"
            style={{
        ...
        {/* Central Section with 3D Cube and Cards */}
        <div className="relative w-full max-w-7xl h-screen flex items-center justify-center">
          ...
          >
            {/* Cube Container */}
            <img src="https://cdn.prod.website-files.com/6847119f22b5391772dbf625/6847119f22b5391772dbf6bf_about%20box.webp" loading="lazy" alt="" className="success-main-image" style={{ transform: 'translate3d(0px, 10px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)', transformStyle: 'preserve-3d', willChange: 'transform' }} />
          </div>
